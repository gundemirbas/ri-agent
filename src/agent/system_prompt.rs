...
pub fn build_system_prompt(
    ...
    guidelines.push("For rich or structured writes, create a UTF-8 no-BOM payload file and pass it through a file/stdin option rather than embedding the payload in shell command arguments. Retrieve and verify the stored result after every such write.".to_string());
